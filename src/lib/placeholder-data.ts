...
export const placeholderWords: Word[] = [
  {
    ...
    dutch: 'Goedemorgen',
    phoneticJavanese: '[su-geng en-jing]',
    category: 'Greetings',
    level: 'Beginner',
    formality: 'krama',
  ...
  },
  {
    ...
    dutch: 'Dank u wel',
    phoneticJavanese: '[ma-tur nu-wun]',
    category: 'Politeness',
    level: 'Beginner',
    formality: 'krama',
  ...
  },
  {
    ...
    dutch: 'Hoe heet u?',
    phoneticJavanese: '[sin-ten as-ma-ni-pun sam-pe-yan]',
    category: 'Phrases',
    level: 'Intermediate',
    formality: 'krama',
  ...
  },
  {
    ...
    dutch: 'Hoe heet jij?',
    phoneticJavanese: '[sa-pa je-neng-mu]',
    category: 'Phrases',
    level: 'Intermediate',
    formality: 'ngoko',
...
export const placeholderAdminUsers: UserType[] = [
    { id: 'user1', name: 'Jan Jansen', email: 'jan@example.com', roles: ['user'], xp: 1500, streak: 10, badges: ['newbie', 'wordmaster_lvl1'], lastLogin: new Date(Date.now() - 172800000), completedLessonIds: ['gl1', 'gl2'], quizAttempts: [{userId:'user1', quizId: 'quizSet1', totalQuestions: 2, correctAnswers: 2, scorePercentage: 100, status: 'Perfect', perfect: true, attempts: 1, completedAt: new Date()}]},
