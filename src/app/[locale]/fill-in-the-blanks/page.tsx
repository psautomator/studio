...
export default function FillInTheBlanksPage() {
  ...
  }, [translations.noHintAvailable, translations]); // Added translations to dependency array
    ...
    return (
      <MainAppLayout>
        ...
        <div className="flex justify-center">
          <div className="flex items-center justify-center h-64 w-full max-w-2xl">
  ...
  if (!currentExercise) {
    return <MainAppLayout><PageHeader title={translations.fillInTheBlanks} /><div className="flex justify-center"><p>Loading exercise...</p></div></MainAppLayout>;
  }
  ...
  return (
    <MainAppLayout>
      ...
      <div className="flex justify-center"> {/* Main centering wrapper */}
        <div className="w-full max-w-2xl"> {/* Content block wrapper */}
