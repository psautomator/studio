...
const translationsData = {
  en: {
    ...
    progress: "Progress",
    progressDescription: "Track your learning journey and achievements.",
    yourBadges: "Your Badges",
    badgesToUnlock: "Badges to Unlock",
    lessonsCompleted: "Lessons Completed",
    grammarLessonsMastered: "Grammar lessons mastered",
    goals: "Goals",
    goalsDescription: "Set and track your daily Javanese learning objectives.",
    generateNewGoals: "Generate New Goals",
    aiGoalGeneratorDesc: "Let our AI help you create personalized learning goals based on your progress and preferences.",
    learningProgressSummary: "Your Learning Progress Summary",
    learningProgressPlaceholder: "e.g., Finished Level 1, good with Ngoko, need Krama practice.",
    learningStylePlaceholder: "e.g., Visual, Auditory, Kinesthetic",
    timeAvailablePlaceholder: "e.g., 30 minutes, 1 hour",
    currentLearningGoals: "Current Learning Goals",
    goalsGenerated: "New Goals Generated!",
    aiGoalsSuccess: "Your personalized learning goals have been created.",
    goalUpdated: "Goal status updated!",
    markAsComplete: "Mark Complete",
    markAsIncomplete: "Mark Incomplete",
    yourPersonalizedTasks: "Your personalized tasks for today.",
    error: "Error",
    grammar: "Grammar",
  ...
  nl: {
    ...
    progress: "Voortgang",
    progressDescription: "Volg je leerreis en prestaties.",
    yourBadges: "Jouw Badges",
    badgesToUnlock: "Te Ontgrendelen Badges",
    lessonsCompleted: "Lessen Voltooid",
    grammarLessonsMastered: "Grammaticalessen beheerst",
    goals: "Doelen",
    goalsDescription: "Stel en volg je dagelijkse Javaanse leerdoelen.",
    generateNewGoals: "Genereer Nieuwe Doelen",
    aiGoalGeneratorDesc: "Laat onze AI je helpen gepersonaliseerde leerdoelen te creëren op basis van je voortgang en voorkeuren.",
    learningProgressSummary: "Samenvatting van je Leervoortgang",
    learningProgressPlaceholder: "Bijv. Niveau 1 afgerond, goed in Ngoko, Krama oefening nodig.",
    learningStylePlaceholder: "Bijv. Visueel, Auditief, Kinesthetisch",
    timeAvailablePlaceholder: "Bijv. 30 minuten, 1 uur",
    currentLearningGoals: "Huidige Leerdoelen",
    goalsGenerated: "Nieuwe Doelen Gegenereerd!",
    aiGoalsSuccess: "Je gepersonaliseerde leerdoelen zijn aangemaakt.",
    goalUpdated: "Goal status bijgewerkt!",
    markAsComplete: "Markeer als Voltooid",
    markAsIncomplete: "Markeer als Onvoltooid",
    yourPersonalizedTasks: "Jouw gepersonaliseerde taken voor vandaag.",
    error: "Fout",
    grammar: "Grammatica",
